  ...
  return (
    <div className='grid 2xl:grid-cols-4 xl:grid-cols-3 lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1 sm:gap-4 gap-8 w-full justify-items-center'>
      {Array(12).fill(0).map((v, i) => (
        <div key={i} className='max-w-xs m-4 w-full justify-center  flex-shrink-0 rounded-xl border-white border-2 animate-pulse items-center'>
          ...
          <div className='p-4 rounded-b-xl flex-col flex justify-between'>
            <div className='text-lg font-semibold h-16 w-5/6'>
              <div className="h-2.5 bg-gray-200 rounded-full dark:bg-gray-700 w-48 mb-4"></div>
            </div>
            <div className='h-24'>
              <div className='border-t-1 border-t mt-3 pt-3'>
